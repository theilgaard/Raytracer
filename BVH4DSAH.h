#ifndef CSE168_BVH4DSAH_H_INCLUDED
#define CSE168_BVH4DSAH_H_INCLUDED
...
class BVH4DSAH : public AccStructure
{
public:
	BVH4DSAH(int tempSamples) : temporalSamples(tempSamples) { nBoxes = 0; nLeafs = 0; tSplits = 0, dupPointers = 0;}
